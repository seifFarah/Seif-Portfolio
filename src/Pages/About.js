        ...
        <div className="section-follow">
          <div className="follow-content">
            <div className="life-exp">
              ...
              <p className="exp-text">I enjoy travelling and exploring new places. I was lucky enough to be able to visit UAE and Turkey before coming to New Zealand.</p>
              <br />
              <p className="exp-text">I enjoy reading! My favorite read recently was 'A Thousand Splendid Suns' by Khaled Hosseini.</p>
              <br />
              <p className="exp-text">If I have some free time on my hands, I love making Spotify playlists and discovering new music. I find it quite therapeutic.</p>
            </div>
            <div className="work-exp">
              <h1 className="exp-title">At Work</h1>
              <p className="exp-text">During university, I got to explore a wide array of topics in the technology field.</p>
              <br />
              <p className="exp-text">The main topic that I found myself invested in is UI/UX design. I enjoy working on web designs and exploring different design options that could improve the user experience.</p>
              <br />
              <p className="exp-text">I am interested in the intersection of UX design and Data. I find the power to inform storytelling an extremely valuable and exciting premise. Something I am interested in developing in the future.</p>
            </div>
          </div>
        </div>
        ...
        <div className="section-projects">
          ...
          <div className="project-content">
            ...
            <div className="project">
              ...
              <p className="project-text">Creating content and graphic designs is a personal hobby. I experimented with social media design in high school and now contribute to the Biztech Society, creating graphics to attract students interested in the intersection of business and technology.</p>
              <br />
              <div className="design-gallery">
                <Carousel showThumbs={false} showStatus={false} infiniteLoop={true} useKeyboardArrows={true} autoPlay={true} interval={3000}>
                  {designs.map((design, index) => (
                    <div key={index}>
                      <img src={`${process.env.PUBLIC_URL}/${design}`} alt={`Design ${index + 1}`} className="design-image" />
                    </div>
                  ))}
                </Carousel>
              </div>
        ...
        <div id="experience" className="section-three">
          ...
          <div className="timeline">
            <div className="job">
              ...
              <hr />
              <p className="job-period">In a three-day intense case cracking competition, my team and I got advanced to the finals. We placed fourth place out of forty competing teams in this division. Consistently integrating feedback we received from Baker Tilly and Case Member judges.</p>
            </div>
            <div className="job">
